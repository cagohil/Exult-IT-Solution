            ...
            <div className="col-lg-8">
              <div className="main-info">
                <div className="main-img img-cover container" >
                  <img src="/assets/img/projects/websiteDevelopment.jpg" alt="" />
                </div>
            ...
            <div className="col-lg-4">
              <div className="side-links mt-5 mt-lg-0">
                ...
                <div className="links-card mb-40">
                  ...
                  <ul>
                    <li>
                      <Link href="/blogs/Few-Important-Tips-before-Hiring-Company-for-Your-Web-Application-Needs/"> <i className="far fa-angle-right icon"></i> Few Important Tips before Hiring Company for Your Web Application Needs </Link>
                    </li>
                    <li>
                      <Link href="/blogs/Why-Do-People-Choose-The-Exult-It-Solution-Which-Types-Of-Service-Do-We-Provide/"> <i className="far fa-angle-right icon"></i> Why Do People Choose The Exult It Solution? Which Types Of Service Do We Provide? </Link>
                    </li>
                    <li >
                      <Link href="/blogs/Website-Development-Eight-Stages-of-A-Complete-Guide/"> <i className="far fa-angle-right icon"></i> Website Development – 8 Stages of A Complete Guide </Link>
                    </li>
                    <li>
                      <Link href="/blogs/Top-Web-Technologies-That-Every-Web-Developer-Must-Know/"> <i className="far fa-angle-right icon"></i> Top Web Technologies That Every Web Developer Must Know in 2023 </Link>
                    </li>
                    <li>
                      <Link href="/blogs/Why-Website-Design-Development-Is-Essential-And-How-It-Helps-In-Making-Your-Business-Profitable/"> <i className="far fa-angle-right icon"></i> Why Website Design & Development Is Essential And How It Helps In Making Your Business Profitable? </Link>
                    </li>
                  </ul>
                </div>
